...
def main():
    # Base save path
    base_path = "../../harmlessness/PkuAnthropic"
    ...
    prepare_and_save(hh_rlhf, os.path.join(base_path, "PkuAnthropic-Target"), is_hh=True)
    # Target: SafeRLHF
    prepare_and_save(safe_rlhf, os.path.join(base_path, "PkuAnthropic-Bench"), is_hh=False)

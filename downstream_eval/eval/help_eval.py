...
import os
import argparse
from utils_pairwise import DeepSeekJudge, run_pairwise, DEFAULT_SYSTEM_PROMPT, DEFAULT_USER_TEMPLATE
...
def main():
    ...
    ap.add_argument("--system_prompt", default=DEFAULT_SYSTEM_PROMPT, type=str)
